...
namespace Bullseye
{
	public class BullseyeConfigSynced : AngelConfigBase
	{
		...
		public override AngelConfigSetting[] GetConfigSettings()
		{
			...
			{
				new AngelConfigSettingSimpleFloat("AimDifficulty", "Aim Difficulty", "AimDifficulty", 0, 1000),

				new AngelConfigSettingSimpleFloat("ArrowDamage", "Arrow Damage", "ArrowDamage", 0, 1000),
				new AngelConfigSettingSimpleFloat("SpearDamage", "Spear Damage", "SpearDamage", 0, 1000),
				new AngelConfigSettingSimpleFloat("SlingDamage", "Sling Damage", "SlingDamage", 0, 1000),
